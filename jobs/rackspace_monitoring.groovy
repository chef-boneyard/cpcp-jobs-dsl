...
String name = 'rackspace_monitoring-cookbook'
String repourl = 'https://github.com/rackspace-cookbooks/rackspace_monitoring.git'

def kitchenFile = readFileFromWorkspace('tk/rackspace_monitoring.yml')
